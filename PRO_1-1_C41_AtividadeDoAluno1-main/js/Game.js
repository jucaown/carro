class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      var index = allPlayers[plr].index;
      this.loseHealth(index);
      }
      ...
      for (var plr in allPlayers) {
        ...
        var lifeDuration = allPlayers[plr].life
        if(lifeDuration <= 0)
        {
  ...
  showFuelBar() {
    ...
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 350, 185, 20, 20);
    fill(255,255,102);
  ...
  handleFuel(index) {
    ...
    if (this.carmoving == true && player.fuel > 0){
      //total = 1
      player.fuel -= 0.5;
    }    
